...
export default async function LoginPage({
  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col items-center justify-center gap-8 px-4 py-16">
      <div className="text-center">
        <h1 className="font-heading text-3xl font-semibold">Welcome to {brand.name}</h1>
